...
import com.hackathon.fmanage.retail.views.RetailInvoiceView;
...
public class DashboardUI extends UI {
    ...
    private void buildLoginView(final boolean exit) {
        ...
        Label title = new Label("Hackathon");
    ...
    private void buildMainView() {
                ...
                addComponent(new VerticalLayout() {
                    {
                        ...
                        addComponent(new VerticalLayout() {
...

							{
                                ...
                                Label userName = new Label("Hack User");
        ...
        for (final String view : new String[] {"dashboard"}) {
